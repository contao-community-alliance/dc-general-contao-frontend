 ...
 *
 * (c) 2012-2025 Contao Community Alliance.
 *
 ...
 * @copyright  2012-2025 Contao Community Alliance.
 * @license    https://github.com/contao-community-alliance/dc-general/blob/master/LICENSE LGPL-3.0-or-later
 * @filesource
 */

namespace ContaoCommunityAlliance\DcGeneral\ContaoFrontend\Filter;
...
class LanguageFilter implements EventSubscriberInterface
{
    ...
    private function checkLanguageSubmit(EnvironmentInterface $environment, array $languages): void
    {
        ...
        // Set language as predefined value.
        if ($inputProvider->hasParameter('__setlng')) {
            $newLanguage = $inputProvider->getParameter('__setlng');
            $this->selectLanguage($newLanguage, $languages, $environment);
            $newUrl = UrlBuilder::fromUrl(Environment::get('request'))->unsetQueryParameter('__setlng')->getUrl();
